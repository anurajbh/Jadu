RandomColor[] colors=new RandomColor[6];

int [] randStrokeWeight = {5,25,50,100};
RandomStroke[] strokes=new RandomStroke[6];
...
void draw() 
{
  //how come the circles cant keep drawing over and over again while the mouse is pressed? upon mouse released it goes back to randomly sized squares.... 
  strokeWeight(0);
...
void mouseReleased()
{
  ...
  radius=random(100,1000);//RANDOMIZING THE CIRCLE SIZE BETWEEN 100 AND 1000 - A
  ellipse(mouseX, mouseY, radius, radius);
 }
